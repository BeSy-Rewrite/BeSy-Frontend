...
export const ordersTableConfig: OrdersTableConfig = [
  ...
  { id: 'owner_id', label: ORDER_FIELD_NAMES['owner_id'].replace(' ', '\u00A0') },
  ...
  { id: 'quote_price', label: ORDER_FIELD_NAMES['quote_price'], isInvisible: true },
  {
    ...
    label: ORDER_FIELD_NAMES['delivery_person_id'].replace(' ', '\u00A0'),
    isInvisible: true,
  },
  ...
  {
    id: 'secondary_cost_center_id',
    label: ORDER_FIELD_NAMES['secondary_cost_center_id'],
    isInvisible: true,
  },
  ...
  {
    id: 'comment_for_supplier',
    label: ORDER_FIELD_NAMES['comment_for_supplier'],
    isInvisible: true,
  },
  ...
  {
    id: 'flag_decision_cheapest_offer',
    label: ORDER_FIELD_NAMES['flag_decision_cheapest_offer'],
    isInvisible: true,
  },
  {
    id: 'flag_decision_sole_supplier',
    label: ORDER_FIELD_NAMES['flag_decision_sole_supplier'],
    isInvisible: true,
  },
  {
    id: 'flag_decision_contract_partner',
    label: ORDER_FIELD_NAMES['flag_decision_contract_partner'],
    isInvisible: true,
  },
  {
    id: 'flag_decision_other_reasons',
    label: ORDER_FIELD_NAMES['flag_decision_other_reasons'],
    isInvisible: true,
  },
  {
    id: 'decision_other_reasons_description',
    label: ORDER_FIELD_NAMES['decision_other_reasons_description'],
    isInvisible: true,
  },
