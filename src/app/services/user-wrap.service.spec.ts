...
describe('UserWrapService', () => {
  ...
  const mockOrderItems2: ItemResponseDTO[] = [{ item_id: 3, quantity: 10, price_per_unit: 250 }];
  ...
  beforeEach(() => {
    ...
    const cachedOrdersServiceSpyObj = jasmine.createSpyObj('CachedOrdersService', ['getAllOrders']);
    ...
    ordersServiceSpy = TestBed.inject(OrdersWrapperService) as jasmine.SpyObj<OrdersWrapperService>;
  ...
  describe('getHistory', () => {
    ...
    it('should filter by period when specified', done => {
      ...
      const wrapHalfYear: UserWrap = {
        ...mockWrap,
        id: 'wrap-half-year-2025',
        period: 'half-year',
      };
  ...
  describe('Metric Calculations', () => {
    ...
    it('should calculate process duration correctly', done => {
      ...
      subResourceResolverSpy.resolveOrderSubresources.and.returnValue(of(mockOrderDisplayData1));
      ordersServiceSpy.getOrderItems.and.returnValue(Promise.resolve(mockOrderItems1));
      mailTrackingServiceSpy.getMailsSentForOrder.and.returnValue(of(5));
      userServiceSpy.addCurrentUserPreference.and.returnValue(
        of({ id: 1, preference_type: 'ORDER_PRESETS', preferences: {} })
  ...
  describe('Headline Generation', () => {
    ...
    it('should generate appropriate headline based on spending', done => {
      ...
      subResourceResolverSpy.resolveOrderSubresources.and.returnValue(of(highValueDisplayData));
      ordersServiceSpy.getOrderItems.and.returnValue(Promise.resolve(mockOrderItems1));
      ordersServiceSpy.getOrderStatusHistory.and.returnValue(Promise.resolve(mockStatusHistory1));
      mailTrackingServiceSpy.getMailsSentForOrder.and.returnValue(of(5));
      userServiceSpy.addCurrentUserPreference.and.returnValue(
  ...
  describe('Comparison Logic', () => {
    ...
    it('should calculate percentage deltas correctly', done => {
      ...
      subResourceResolverSpy.resolveOrderSubresources.and.returnValue(of(mockNewOrderDisplayData));
      ordersServiceSpy.getOrderItems.and.returnValue(Promise.resolve(mockOrderItems1));
      ordersServiceSpy.getOrderStatusHistory.and.returnValue(Promise.resolve(mockStatusHistory1));
      mailTrackingServiceSpy.getMailsSentForOrder.and.returnValue(of(5));
      userServiceSpy.addCurrentUserPreference.and.returnValue(
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle API errors during order fetching', done => {
      cachedOrdersServiceSpy.getAllOrders.and.returnValue(throwError(() => new Error('API Error')));
